...
> {
   ...
   */
  addStorage(storage: CogniStorageInterface<TParam, TResult>) {
   ...
   */
  removeStorage(storage: CogniStorageInterface<TParam, TResult>) {
 ...
 */
export interface CogniStorageInterface<
  TParam extends Record<string, any> = DefaultRecord,
  TResult extends Record<string, any> = DefaultRecord,
> {
  /**
